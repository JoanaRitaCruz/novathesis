...
\nttitle(main,en){Interacting with culture: A storytelling approach\\for on-site museum visits}%
\nttitle(main,pt){Interagindo com cultura; Uma abordagem narrativa\\ para visitas presenciais}%
...
%-------------------------------------------------------------------
\ntauthorname(m){Joana Rita Fernandes Botelho Cruz}{Joana Cruz}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,f){Teresa Isabel Lopes Romão, Full Professor, NOVA University Lisbon}
% Co-advisers(s)
\ntaddperson{adviser}(c,m){Nuno Manuel Robalo Correia, Associate Professor, NOVA University Lisbon}
